...
from bu_agent_sdk.mcp.types import SdkMcpTool
...
def mcp_tool(name: str, description: str) -> Callable[[TFunc], TFunc]:
    ...
    def decorator(func: TFunc) -> TFunc:
        ...
        setattr(func, "_bu_agent_sdk_mcp_tool_name", str(name))
        setattr(func, "_bu_agent_sdk_mcp_tool_description", str(description))
