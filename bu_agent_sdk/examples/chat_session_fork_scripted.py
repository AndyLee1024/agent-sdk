...
logger = logging.getLogger("bu_agent_sdk.examples.chat_session_fork_scripted")
...
async def main() -> None:
    ...
    logger.info("Run: uv run python bu_agent_sdk/examples/chat_session_fork_scripted.py")
