...
from bu_agent_sdk.agent.runner import check_and_compact, generate_max_iterations_summary
from bu_agent_sdk.agent.tool_exec import execute_tool_call, extract_screenshot
...
async def query_stream(
    ...
    while iterations < agent.max_iterations:
        ...
        from bu_agent_sdk.llm.messages import AssistantMessage
