...
class Agent:
    ...
    def clear_history(self):
        ...
        tool_strategy = generate_tool_strategy(self.tools)
        if tool_strategy:
            self._context.set_tool_strategy(tool_strategy)
...
Keep the summary brief but informative."""
    ...
    async def query(self, message: str) -> str:
        ...
        # 注册初始 TODO 提醒（如果需要）
        self._context.register_initial_todo_reminder_if_needed()
    ...
    def _setup_tool_strategy(self) -> None:
        ...
        根据当前注册的工具动态生成 <system_tools_definition> 段并写入 ContextIR header。
        """
        from bu_agent_sdk.agent.tool_strategy import generate_tool_strategy
