...
from bu_agent_sdk.context.items import ItemType, SegmentName
...
logger = logging.getLogger("bu_agent_sdk.context.lower")
...
class LoweringPipeline:
    ...
    def _build_header_text(context: ContextIR) -> str:
        ...
        顺序：system_prompt → subagent_strategy → skill_strategy
        """
        parts: list[str] = []
    ...
    def _inject_reminders(
        ...
        if ReminderPosition.LAST_TOOL_RESULT in by_position:
            from bu_agent_sdk.llm.messages import ToolMessage
