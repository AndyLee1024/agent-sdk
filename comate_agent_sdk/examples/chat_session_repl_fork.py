...
logger = logging.getLogger("comate_agent_sdk.examples.chat_session_repl_fork")
...
def _help_text() -> str:
    return (
        ...
        "\n"
        "Run:\n"
        "  uv run python comate_agent_sdk/examples/chat_session_repl_fork.py\n"
    )
...
async def main() -> None:
    ...
    agent = Agent(llm=llm, config=AgentConfig(tools=[]))
