...
_Original: Oct 26, 2025 • Han Lee_
...
![Claude Skill Flowchart](./Claude Agent Skills_ A First Principles Deep Dive_files/01-claude-skill-1.png)
...
![skill-creator package](./Claude Agent Skills_ A First Principles Deep Dive_files/03-claude-skill-package.png)
...
![Claude Desktop Skill](./Claude Agent Skills_ A First Principles Deep Dive_files/02-claude-desktop-skill.png)
...
![Claude Skills Frontmatter](./Claude Agent Skills_ A First Principles Deep Dive_files/04-claude-skill-frontmatter.png)
...
- **MCP Best Practices**: [📋 View Best Practices](./reference/mcp\_best\_practices.md) - Core guidelines for all MCP servers

**For Python implementations, also load:**
- **Python SDK Documentation**: Use WebFetch to load `https://raw.githubusercontent.com/modelcontextprotocol/python-sdk/main/README.md`
- [🐍 Python Implementation Guide](./reference/python\_mcp\_server.md) - Python-specific best practices and examples

**For Node/TypeScript implementations, also load:**
- **TypeScript SDK Documentation**: Use WebFetch to load `https://raw.githubusercontent.com/modelcontextprotocol/typescript-sdk/main/README.md`
- [⚡ TypeScript Implementation Guide](./reference/node\_mcp\_server.md) - Node/TypeScript-specific best practices and examples
...
![Claude Skill Script Automation](./Claude Agent Skills_ A First Principles Deep Dive_files/09-script-automation.png)
...
`python {baseDir}/scripts/analyzer.py --path "$USER\_PATH" --output report.json`
...
![Claude Skill Read Process Write](./Claude Agent Skills_ A First Principles Deep Dive_files/10-read-process-write.png)
...
![Claude Skill Search Analyze Report](./Claude Agent Skills_ A First Principles Deep Dive_files/06-search-analyze-report.png)
...
![Claude Skill Command Chain Execution](./Claude Agent Skills_ A First Principles Deep Dive_files/05-command-chain-execution.png)
...
![Claude Skill Execution Flow](./Claude Agent Skills_ A First Principles Deep Dive_files/08-claude-skill-execution-flow.png)
...
| **Message Role** | assistant → tool\_useuser → tool\_result | assistant → tool\_use Skilluser → tool\_resultuser → skill prompt ← INJECTED! |
...
Important:
- Only use skills listed in <available\_skills> below
...
![Claude Skill Execution Flow](./Claude Agent Skills_ A First Principles Deep Dive_files/07-claude-skill-sequence-diagram.png)
...
async function loadPluginSkills(plugin) {
  ...
  for (const file of skillFiles) {
    ...
    skills.push({
      ...
      whenToUse: frontmatter.when\_to\_use,  // ← Note: underscores!
...
![Turn 1 Completion](./Claude Agent Skills_ A First Principles Deep Dive_files/11-turn-1-completion.png)
